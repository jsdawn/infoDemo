 ...
 */
;(function() {
//localStorage.setItem("cdnUrl",window.SITE_CONFIG.cdnUrl);
  var resList = {
    icon: window.SITE_CONFIG.cdnUrl + '/static/img/favicon.ico',
    css: [
      window.SITE_CONFIG.cdnUrl + '/static/element-ui-theme/element-17B3A3/index.css',
  ...
  (function () {
    ...
    var createStyles = function () {
      ...
      if(resList.css[i].indexOf("element-ui-theme/element-17B3A3/index.css")> -1){
        _style.id="themeLink";
      }
